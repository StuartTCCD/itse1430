...
namespace CharacterCreator.ConsoleHost
{
    class CharacterCreatorConsoleHost
    {
        ...
        static void Main ( string[] args )
        {
            ...
            //Console.WriteLine(_character.characterName);
            //Console.WriteLine(_character.characterProfession);
            //Console.WriteLine(_character.characterRace);
            //Console.WriteLine(_character.characterAttributeValue[0]);
            //Console.WriteLine(_character.characterBiography);
        }
