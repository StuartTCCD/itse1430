...
namespace CharacterCreator.Winhost
{
    public partial class MainForm : Form
    {
        ...
        {
            Form characterCreator = new CreateNewCharacter(this);
            characterCreator.StartPosition = FormStartPosition.CenterParent;
            //characterCreator.StartPosition = FormStartPosition.Manual;
            //characterCreator.Location = new Point(Width / 2 - characterCreator.Width / 2 + Location.X,
            //                          Height / 2 - characterCreator.Height / 2 + Location.Y);
        ...
        private void OnCharacterEdit ( object sender, EventArgs e )
        {
            ...
            //characterEditor.StartPosition = FormStartPosition.Manual;
            //characterEditor.Location = new Point(Width / 2 - characterEditor.Width / 2 + Location.X,
            //                            Height / 2 - characterEditor.Height / 2 + Location.Y);
